...
namespace GameRenderer
{
    public class TextureVertexGeometry : Geometry
    {
        ...
        public override void DefineData()
        {
            ...
            GL.VertexAttribPointer(1, 3, VertexAttribPointerType.Float, false, ColorVertex.ByteSize, 3  * sizeof(float));
            
            GL.EnableVertexAttribArray(2);
            GL.VertexAttribPointer(2, 2, VertexAttribPointerType.Float, false, ColorVertex.ByteSize, 6  * sizeof(float));
        }
